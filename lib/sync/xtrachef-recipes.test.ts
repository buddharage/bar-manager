...
const SAMPLE_RECIPES: FullRecipe[] = [
  {
    recipe: {
      ...
      image_url: "https://img.xtrachef.com/margarita.jpg",
      instructions: "Combine ingredients, shake with ice, strain into glass",
  ...
  },
  {
    recipe: {
      ...
      notes: null,
      image_url: null,
      instructions: "Dissolve sugar in equal parts hot water",
